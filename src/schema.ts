...
export interface components {
  schemas: {
    ...
    Metadata: {
       ...
       */
      schema: {
        [key: string]: components["schemas"]["Metadatum"] | undefined;
      };
    };
    Metadatum:
      | components["schemas"]["Metadatum_Int"]
      | components["schemas"]["Metadatum_String"]
      | components["schemas"]["Metadatum_Bytes"]
      | components["schemas"]["Metadatum_List"]
      | components["schemas"]["Metadatum_Map"];
    /** int */
    Metadatum_Int: {
     ...
     *      */
    Pattern:
      | components["schemas"]["Wildcard"]
      | components["schemas"]["AddressPattern"]
      | components["schemas"]["AssetIdPattern"]
      | components["schemas"]["OutputReferencePattern"];
    /** Point */
    Point: {
      slot_no: components["schemas"]["SlotNo"];
      header_hash: components["schemas"]["HeaderHash"];
    ...
    Script: {
       ...
       * @enum {string}
       */
      language: "native" | "plutus:v1" | "plutus:v2";
      /**
    ...
    Match: {
      ...
      spent_at: components["schemas"]["Point"] | null;
    };
